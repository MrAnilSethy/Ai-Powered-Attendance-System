...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name",placeholder='e.g. Anil Sethy')
            ...
            audio_data = None
            try:
                audio_data = st.audio_input('Record a short phase like I am present,My name is Anil.')
            except Exception:
                    ...
                    with st.spinner('Creating profile...'):
                        ...
                        if encodings:
                            ...
                            if response_data:
                                ...
                                st.error('Couldnt capture your facial features or registrations')
