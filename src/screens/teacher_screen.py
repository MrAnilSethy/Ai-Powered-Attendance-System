...
def teacher_tab_attendance_records():
    ...
    for r in records:
        ...
        data.append({
            ...
            "Time":datetime.fromisoformat(ts).strftime("%Y-%m-%d %I:%M %p") if st else "N/A",
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter your username",placeholder="e.g @anil")
    teacher_name = st.text_input("Enter your fullname",placeholder="e.g Anil Sethy")
